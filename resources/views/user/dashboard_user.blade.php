...
<div id="catalog" class="w-full h-auto mt-10 flex flex-col items-center justify-center bg-choco bg-opacity-50">
    ...
    <div id="catalog-container" class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 xm:grid-cols-2 xxm:grid-cols-2 lg:gap-5 md:gap-5 sm:gap-5 xm:gap-3 mx-4 xxm:gap-1 mt-3 opacity-0 transform scale-95 transition-all duration-700 ease-in-out">
...
<div class=" lg:absolute md:absolute lg:w-384 md:w-52 sm:w-80 xm:w-auto lg:mr-120 md:mr-96" id="kontak">
    ...
    <a href="https://wa.me/62895352224863" type="button" class="mt-5 text-krem bg-coklat font-medium rounded-lg lg:text-sm md:text-10 sm:text-8 xm:text-8 xxm:text-8 px-5 py-2.5 text-center inline-flex sm:ml-24  xxm:ml-6 lg:ml-0 md:ml-0 me-2 mb-2">
