...
<div id="kelebihan" class="w-full h-auto mt-16 flex flex-col items-center justify-center">
    <h1 class="lg:text-3xl md:text-2xl sm:text-xl xm:text-xl font-bold text-coklat">KELEBIHAN ATHA MEBEL</h1>
    <div class="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 xm:grid-cols-2 gap-5 mt-16">
    <div class="col-span-2 md:col-span-1 flex justify-center">
            <a class=" lg:w-card lg:h-card md: w-347 md:h-233  w p-6 bg-krem border border-gray-200 rounded-lg shadow flex flex-col justify-center items-center">
                ...
                <h5 class="mb-2 lg:text-xl md:text-17 sm:text-14 xm:text-12 font-semibold tracking-tight text-black dark:text-white text-center">Bisa Custom Sesuai Kebutuhan </h5>
                <p class="font-normal lg:text-17 md:text-14 sm:text-14 xm:text-10 text-black text-center">Kami memberikan pelayanan untuk menyesuaikan ukuran, warna, dan desain mebel sesuai dengan permintaan pelanggan.</p>
            </a>
        </div>
        ...
        <div class="col-span-2 md:col-span-1 flex justify-center">
            <a class=" lg:w-card lg:h-card md: w-347 md:h-233 w p-6 bg-krem border border-gray-200 rounded-lg shadow flex flex-col justify-center items-center">
                <img src="../img/like icon.png" class="lg:h-7 lg:w-7 md:h-5 md:w-5 mb-2">
                <h5 class="mb-2 lg:text-xl md:text-17 sm:text-14 xm:text-12 font-semibold tracking-tight text-black dark:text-white text-center">Harga Lebih Ekonomis</h5>
                <p class="font-normal lg:text-17 md:text-14 sm:text-14 xm:text-10 text-black text-center">Kami menawarkan harga yang lebih ekonomis dibandingkan dengan banyak kompetitor bagi konsumen yang mencari solusi mebel berkualitas dengan anggaran terbatas.</p>
            </a>
        </div>
        ...
        <div class="col-span-2 md:col-span-1 flex justify-center">
            <a class=" lg:w-card lg:h-card md: w-347 md:h-233 w p-6 bg-krem border border-gray-200 rounded-lg shadow flex flex-col justify-center items-center">
                <img src="../img/like icon.png" class="lg:h-7 lg:w-7 md:h-5 md:w-5 mb-2">
                <h5 class="mb-2 lg:text-xl md:text-17 sm:text-14 xm:text-12 font-semibold tracking-tight text-black dark:text-white text-center">Melayani Pesanan Mebel dari Bahan Kayu</h5>
                <p class="font-normal lg:text-17 md:text-14 sm:text-14 xm:text-10 text-black text-center">Kami melayani pembuatan mebel dari berbagai jenis material, termasuk kayu solid dan multiplek yang dilapisi dengan High Pressure Laminate (HPL).</p>
            </a>
        </div>
        ...
        <div class="col-span-2 md:col-span-1 flex justify-center">
            <a class=" lg:w-card lg:h-card md: w-347 md:h-233 w p-6 bg-krem border border-gray-200 rounded-lg shadow flex flex-col justify-center items-center">
                <img src="../img/like icon.png" class="lg:h-7 lg:w-7 md:h-5 md:w-5 mb-2">
                <h5 class="mb-2 lg:text-xl md:text-17 sm:text-14 xm:text-12 font-semibold tracking-tight text-black dark:text-white text-center">Pengerjaan Rapi Dikerjakan oleh Ahli di Bidangnya </h5>
                <p class="font-normal lg:text-17 md:text-14 sm:text-14 xm:text-10 text-black text-center">Kami menjamin kualitas pengerjaan yang rapi dan detail. Dengan mempekerjakan tenaga ahli yang berpengalaman dalam bidang pembuatan mebel.</p>
            </a>
        </div>
...
<div id="catalog" class="w-full h-auto mt-10 flex flex-col items-center justify-center bg-choco bg-opacity-50">
    <h1 class="lg:text-3xl md:text-2xl sm:text-xl xm:text-xl font-bold text-coklat mt-10">KATALOG</h1>

    <div id="category-buttons-container" class="mt-3 overflow-y-auto overflow-x-auto w-full lg:w-1094 md:w-677 sm:w-384 xm:w-247">
        <div id="category-buttons" class="flex gap-5 mt-3 sm:hidden lg:block md:block">
            <!-- Dynamic category buttons will be inserted here -->
        </div>
    </div>

    <div id="catalog-container" class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 xm:grid-cols-2 gap-5 mt-3 opacity-0 transform scale-95 transition-all duration-700 ease-in-out">
...
<script>
    ...
    function createCard(title, image, category, description) {
        ...
        button.innerHTML = `
            ...
            <div class="p-5">
                ...
                <h4 class="lg:text-lg md:text-lg font-medium sm:text-sm xm:text-10 text-coklat mr-auto text-left">${title}</h4>
            </div>
        `;
    ...
    async function initializeCategories() {
        ...
        categories.forEach(category => {
            const button = document.createElement('button');
            button.className = 'filter-btn text-coklat bg-krem hover:bg-coklat hover:text-krem lg:h-11 lg:w-48 md:h-31 md:w-130 font-medium rounded-full lg:text-15 md:text-12 xm:text-8 px-5 py-2.5 text-center me-2 mb-2';
...
<div class="w-full h-auto mt-0 flex flex-col items-center justify-center">
    <img src="../img/Group 18.png" class="lg:w-777 lg:h-587 md:h-325 ml-auto lg:block md:block sm:hidden xm:hidden">
    <img src="../img/Group 21.png" class="lg:w-777 lg:h-587 md:h-325 sm:h-325 ml-auto lg:hidden md:hidden sm:block xm:block">


<div class=" lg:absolute md:absolute lg:w-384 md:w-52 sm:w-80 xm:w-auto lg:mr-120 md:mr-96" id="kontak">
    <a href="#"
        <h5 class="mb-2 lg:text-4xl md:text-20 font-bold tracking-tight text-coklat sm:ml-10 lg:ml-0 md:ml-0 lg:text-left md:text-left sm:text-justify xm:text-center">Hubungi Kami Sekarang Untuk</h5>
        <h5 class="mb-2 lg:text-4xl md:text-20 font-bold tracking-tight text-coklat sm:ml-16 lg:ml-0 md:ml-0 lg:text-left md:text-left sm:text-justify xm:text-center">Informasi Lebih Lanjut</h5>
    </a>
    <a href="https://wa.me/62895352224863" type="button" class="mt-5 text-krem bg-coklat font-medium rounded-lg lg:text-sm md:text-10 sm:text-8 xm:text-8 px-5 py-2.5 text-center inline-flex sm:ml-24 xm:ml-16 lg:ml-0 md:ml-0 me-2 mb-2">
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class=" lg:w-7 lg:h-7 md:w-5 md:h-5 sm:w-4 sm:h-4 xm:w-4 xm:h-4 me-2" viewBox="0 0 50 50"
        style="fill:#FFFFFF;">
