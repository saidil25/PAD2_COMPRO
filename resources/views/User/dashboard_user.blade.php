...
<div class=" lg:absolute md:absolute lg:w-384 md:w-52 sm:w-80 xm:w-auto lg:mr-120 md:mr-96" id="kontak">
    ...
    <a href="https://wa.me/62895352224863" type="button" class="mt-5 text-krem bg-coklat font-medium rounded-lg lg:text-sm md:text-10 sm:text-8 xm:text-8 xxm:text-8 px-5 py-2.5 text-center inline-flex sm:ml-24 xm:ml-16 xxm:ml-6 lg:ml-0 md:ml-0 me-2 mb-2">
