        ...
        <div class="mx-auto relative">
            <template x-for="(slide, index) in slides" :key="index">
                <div x-show="currentIndex === index" class="lg:w-full lg:h-81 lg:bg-cover lg:bg-center md:bg-cover md:bg-center md:h-80 md:w-full sm:bg-cover sm:bg-center sm:w-full sm:h-250" :style="'background-image: url(\'' + slide.url + '\')'">
                    ...
                    <div class="lg:absolute lg:bottom-0 lg:w-full lg:h-81 md:absolute md:bottom-0 md:w-full md:h-80 sm:absolute sm:bottom-0 sm:h-250 sm:w-full flex items-end justify-center bg-gradient-to-t from-c1 via-c2">
                        <div class="text-center lg:w-1094 md:w-677 sm:w-347 text-white lg:mb-10 md:mb-7 sm:mb-4 p-4">
                            <h2 class="lg:text-xl md:text-sm sm:text-10 mb-2" x-text="slide.title"></h2>
...
<div id="kelebihan" class="w-full h-auto mt-32 flex flex-col items-center justify-center">
    ...
    <div class="col-span-2 md:col-span-1 flex justify-center">
            <a class=" lg:w-card lg:h-card md: w-347 md:h-233  w p-6 bg-krem border border-gray-200 rounded-lg shadow flex flex-col justify-center items-center">
                ...
                <h5 class="mb-2 lg:text-xl md:text-17 sm:text-14 md:text-center font-semibold tracking-tight text-black dark:text-white">Bisa Custom Sesuai Kebutuhan </h5>
                <p class="font-normal lg:text-17 md:text-14 sm:text-14 text-black text-center">Kami memberikan pelayanan untuk menyesuaikan ukuran, warna, dan desain mebel sesuai dengan permintaan pelanggan.</p>
            </a>
        </div>
        ...
        <div class="col-span-2 md:col-span-1 flex justify-center">
            <a class=" lg:w-card lg:h-card md: w-347 md:h-233 w p-6 bg-krem border border-gray-200 rounded-lg shadow flex flex-col justify-center items-center">
                <img src="../img/like icon.png" class="lg:h-7 lg:w-7 md:h-5 md:w-5 mb-2">
                <h5 class="mb-2 lg:text-xl md:text-17 sm:text-14 md:text-center font-semibold tracking-tight text-black dark:text-white">Harga Lebih Ekonomis</h5>
                <p class="font-normal lg:text-17 md:text-14 sm:text-14 text-black text-center">Kami menawarkan harga yang lebih ekonomis dibandingkan dengan banyak kompetitor bagi konsumen yang mencari solusi mebel berkualitas dengan anggaran terbatas.</p>
            </a>
        </div>
        ...
        <div class="col-span-2 md:col-span-1 flex justify-center">
            <a class=" lg:w-card lg:h-card md: w-347 md:h-233 w p-6 bg-krem border border-gray-200 rounded-lg shadow flex flex-col justify-center items-center">
                <img src="../img/like icon.png" class="lg:h-7 lg:w-7 md:h-5 md:w-5 mb-2">
                <h5 class="mb-2 lg:text-xl md:text-17 sm:text-14 md:text-center font-semibold tracking-tight text-black dark:text-white">Melayani Pesanan Mebel dari Bahan Kayu</h5>
                <p class="font-normal lg:text-17 md:text-14 sm:text-14 text-black text-center">Kami melayani pembuatan mebel dari berbagai jenis material, termasuk kayu solid dan multiplek yang dilapisi dengan High Pressure Laminate (HPL).</p>
            </a>
        </div>
        ...
        <div class="col-span-2 md:col-span-1 flex justify-center">
            <a class=" lg:w-card lg:h-card md: w-347 md:h-233 w p-6 bg-krem border border-gray-200 rounded-lg shadow flex flex-col justify-center items-center">
                <img src="../img/like icon.png" class="lg:h-7 lg:w-7 md:h-5 md:w-5 mb-2">
                <h5 class="mb-2 lg:text-xl md:text-17 sm:text-14 md:text-center font-semibold tracking-tight text-black dark:text-white">Pengerjaan Rapi Dikerjakan oleh Ahli di Bidangnya </h5>
                <p class="font-normal lg:text-17 md:text-14 sm:text-14 text-black text-center">Kami menjamin kualitas pengerjaan yang rapi dan detail. Dengan mempekerjakan tenaga ahli yang berpengalaman dalam bidang pembuatan mebel.</p>
            </a>
        </div>
